...
//    }
//
//    private fun showCustomNotification(data: Map<String, Any>) {
//        val notificationLayout = RemoteViews(packageName, R.layout.notification_design)
//
//        // Set data in notification layout
//        notificationLayout.setTextViewText(R.id.gate, data["gateNo"] as String)
////        notificationLayout.setTextViewText(R.id, data["seatNo"] as String)
//        notificationLayout.setTextViewText(R.id.departure_time, data["departureTime"] as String)
//        notificationLayout.setTextViewText(R.id.arriving_time, data["arrivalTime"] as String)
////        notificationLayout.setTextViewText(R.id.status,data["status"] as String )
//
//        val progress = data["progress"] as Int
//        notificationLayout.setProgressBar(R.id.custom_progress_bar, 100, progress, false)
//
//        val builder = NotificationCompat.Builder(this, channelId)
//            .setSmallIcon(R.drawable.icons)
//            .setStyle(NotificationCompat.DecoratedCustomViewStyle())
